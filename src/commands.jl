...
@redisfunction "xrange" OrderedDict{AbstractString, Array{AbstractString,1}} key start end_ options...
@redisfunction "xrevrange" OrderedDict{AbstractString, Array{AbstractString,1}} key end_ start options...
