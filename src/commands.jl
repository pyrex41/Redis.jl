...
@redisfunction "xrevrange" Dict{AbstractString, Dict{AbstractString,AbstractString}} key end_ start options...
@redisfunction "xlen" Integer key
@redisfunction "xread" Dict{AbstractString, Dict{AbstractString, Dict{AbstractString, AbstractString}}} options...
