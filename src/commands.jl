...
@redisfunction "xrange" OrderedDict{AbstractString, Array{AbstracString,1}} key start end_ options...
@redisfunction "xrevrange" OrderedDict{AbstractString, Array{AbstracString,1}} key end_ start options...
