...
# Stream commands
@redisfunction "xadd" Integer key ID fvpairs...
@redisfunction "xrange" Dict{AbstractString, Dict{AbstractString,AbstractString}} key start end_ options...
@redisfunction "xrevrange" OrderedDict{AbstractString, Dict{AbstractString,AbstractString}} key end_ start options...
@redisfunction "xlen" Integer key
@redisfunction "xread" Dict{AbstractString, OrderedDict{AbstractString, Dict{AbstractString, AbstractString}}} options...
